  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-6 bg-surface relative overflow-hidden">
      ...
      <div className="fixed inset-0 -z-10 pointer-events-none overflow-hidden">
        ...
        <div className="absolute bottom-[-5%] left-[-10%] w-[30vw] h-[30vw] rounded-full bg-tertiary/5 blur-[100px]"></div>
      </div>

      <motion.div
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        className="w-full max-w-[440px] flex flex-col gap-12"
      >
        <header className="flex flex-col items-center gap-4 text-center">
          <div className="flex items-center gap-2">
            <Layers className="text-primary w-8 h-8" />
            <h1 className="text-2xl font-bold tracking-tighter text-on-surface">TeamTask</h1>
          </div>
          <div className="flex flex-col gap-1">
            <h2 className="text-xl font-semibold tracking-tight text-on-surface">Welcome back</h2>
            <p className="text-on-surface-variant text-sm">Please enter your details to sign in</p>
          </div>
        </header>

        <main className="bg-surface-container-lowest p-8 md:p-10 rounded-xl shadow-[0_12px_40px_-12px_rgba(17,48,105,0.08)] flex flex-col gap-8">
          <Button variant="secondary" className="w-full flex items-center justify-center gap-3">
            <svg className="w-5 h-5" viewBox="0 0 24 24">
              ...
              ></path>
              <path
                d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 6.35l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z"
                fill="#EA4335"
              ></path>
            </svg>
          ...
          <div className="relative flex items-center py-2">
            ...
            <span className="flex-shrink mx-4 text-[10px] font-bold uppercase tracking-[0.1em] text-on-surface-variant/50">
              or
            </span>
            <div className="flex-grow border-t border-outline-variant/20"></div>
          </div>
          ...
          >
            ...
            <div className="flex flex-col gap-2">
              <div className="flex items-center justify-between px-1">
                <label className="text-[10px] font-bold tracking-[0.05em] uppercase text-on-surface-variant">
                  Password
                </label>
        ...
        <footer className="flex flex-col items-center gap-6">
          ...
          <div className="flex items-center gap-6 text-[10px] font-medium text-on-surface-variant/60 uppercase tracking-widest">
